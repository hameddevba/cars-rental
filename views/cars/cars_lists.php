...
<section class="py-5 mt-5  text-center container">
  <div class="row py-lg-5">
    <div class="col-lg-6 col-md-8 mx-auto">
      <h1 class="fw-light">Bienvenu sur CarReservation</h1>
      <p class="lead text-muted">Bonjour et bienvenue sur notre application de location de voitures ! Prêt à embarquer pour une aventure sans tracas sur les routes ? Trouvez votre véhicule idéal et partez explorer en toute liberté !.</p>
      <!-- <p>
          ...
          <div class="card rounded">
            ...
            <div class="card-body text-center">
              ...
              <div class="card-image-overlay m-auto">
                ...
                <span class="card-detail-badge">plus de details</span>
                <span class="card-detail-badge">louer</span>
              </div>
            </div>
